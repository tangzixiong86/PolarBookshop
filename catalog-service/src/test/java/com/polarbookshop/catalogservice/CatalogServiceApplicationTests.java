...
//application-integration.yml 配置 url:jdbc:tc:postgresql:latest:///
//所以此处使用JDBC URL支持，没有必要实例化容器，Testcontainers会自动完成这些工作，
//而BookRepositoryJdbcTests 使用了不同的方式，它直接实例化窗口
